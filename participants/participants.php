...
<body>
    ...
    <div class="telephone">
        ...
        <section class="news">
        <div class="row position-relative margin-bottom-50px">
            <div class="margin-top-160px">
                <div class="navigation_mini margin-bottom-50px">
                    ...
                    <a class="style-link margin-right-10px" href="../news/news.php">Почетные гости</a>
                </div>
                <h2 class="title margin-bottom-50px">Почетные гости</h2>
            </div>
        </div>
        <div class="row">
