const btn_widget = document.querySelector('.btn-widget'),
    ...
    btnDonwlaod = document.querySelector('.btn__donwlaod');
    btnImgDonwlaod = document.querySelector('.btn__img_donwlaod');
    btnDonwlaod2 = document.querySelector('.btn__donwlaod_2');
    btnImgDonwlaod2 = document.querySelector('.btn__img_donwlaod_2');
...
/* наведение на кнопку скачать положение */
btnDonwlaod.addEventListener("mouseover", ()=>{
    btnImgDonwlaod.src = "../icons/btn-img-white.png"
})

btnDonwlaod.addEventListener("mouseout", ()=>{
    btnImgDonwlaod.src = "../icons/btn-img-black.png"
})

btnDonwlaod2.addEventListener("mouseover", ()=>{
    btnImgDonwlaod2.src = "../icons/btn-img-white.png"
})

btnDonwlaod2.addEventListener("mouseout", ()=>{
    btnImgDonwlaod2.src = "../icons/btn-img-black.png"
})
