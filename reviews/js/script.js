...
/* наведение на кнопку открытия формы */
btnOpenForm.addEventListener("mouseover", ()=>{
    btnOpenFormImg.src = "../icons/right-arrow-radius.png"
})
btnOpenForm.addEventListener("mouseout", ()=>{
    btnOpenFormImg.src = "../icons/image 1.svg"
})

/* открытие формы для добавления отзыва */
btnOpenForm.addEventListener("click", ()=>{
    formBackground.classList.remove('display-none')
})

/* закрытие формы для добавления отзыва */
crossForm.addEventListener("click", ()=>{
    formBackground.classList.add('display-none')
})
